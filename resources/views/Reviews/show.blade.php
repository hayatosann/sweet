...
<div class="shop">
        ...
        <div class="shop-data-center">
            ...
            <div class="okini">
                ...
                <form action="{{ route('favorites.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn text-danger"><img src="./css/rogo_okiniiri.jpg" alt="お気に入り星"
                            class="rogo"></button>
                </form>
            </div>
        </div>
    ...
    <div class="shop-map">
        <h3>地図</h3>
        <div class="shop-detail-link">
            <iframe src="https://maps.google.co.jp/maps?output=embed&q={{$store->latitude}}, {{$store->longitude}}"
                frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="294" height="220"></iframe>
        </div>
    </div>
</div>{{-- .shop --}}
</section>
