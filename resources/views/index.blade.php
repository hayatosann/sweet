...
<link rel="stylesheet" type="text/css" href="{{ asset('css/toppageview.css') }}">
@endsection
        ...
        <article class="search">
            ...
            <section class="side_inner_sec side_inner_sec--border_top sec_rush">
                ...
                <div class="search_button">
                    <button type="submit" class="btn_kensaku">検索</button>
                </div> 
                <!-- /検索条件ボタン -->
            </section>
            <!-- /カテゴリー -->
            ...
            {{-- <div class="container">
                <div class="subject">
                    <div class="search-result">
                        ...
                        <button class="toppage-all_clear font"><form action="">検索条件をリセット</form></button>
                    </div>
                </div>
            </div>
          ...
          <div class="content">
            ...
            <div class="usercoment font">
                ...
                <div class="toppage-reviewflex">
                    ...
                    <span class="toppage-reviewflex-star">{{$detail->bestreview()['review']}}</span>
                </div>
                <p class="bestreview-content">{{ $detail->bestreview()['comment'] }}</p>
                <div class="button">
